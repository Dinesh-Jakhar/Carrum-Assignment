  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-gray-100">
      <div className="w-full max-w-4xl p-6 bg-white rounded-lg shadow-md">
        <h1 className="text-2xl font-bold mb-4 text-center">Customer Ride History</h1>
          ...
          <ul className="space-y-4">
            {rideHistory.map((ride) => (
              <li key={ride._id} className="p-4 bg-gray-50 rounded-lg shadow-inner">
                ...
                {/* <p className="mb-2">
                  <span className="font-bold">Customer:</span> {ride.user ? `${ride.user.firstname} ${ride.user.lastname}` : 'Unknown'}
                </p> */}
                <p className="mb-2">
                  <span className="font-bold">Driver:</span> {ride.driver ? `${ride.driver.firstname} ${ride.driver.lastname}` : 'Unknown'}
                </p>
                <p className="mb-2">
